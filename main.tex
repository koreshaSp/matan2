...
\begin{exmpl}\
 \begin{itemize}
  ...
  \item $ X = \R^2 $, $ \mathcal{A} = \left\{ E \subset X \mid E \text{ --- ограничено или } E^c \text { --- ограничено } \right\}  $. Тогда $ \mathcal{A} $ --- алгебра:
   ...
   \begin{align*}
    \R^2 \setminus \left\{ (0, x) \mid x \geqslant 0 \right\} \notin \mathcal{A}  = \bigcap_{k=1}^\infty A_k, \quad A_k \in \mathcal{A}
...
\begin{proof}\
 \begin{enumerate}
  ...
  \item $ A_j \in \mathcal{A} \;\Longrightarrow\; A_j \in \mathcal{A}_i, \forall i, j  \;\Longrightarrow\; \bigcap_j A_j \in 
  \mathcal{A}_i \;\Longrightarrow\; \bigcap_j A_j \in \mathcal{A}$
 \end{enumerate}
\end{proof}
\begin{lm}
