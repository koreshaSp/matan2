...
\begin{proof}\
 ...
 \begin{align*}
  \left\{ i \in I \mid a_i > 0 \right\} = \bigcup_{N \in \N} \left\{ i \in I \mid a_i \geqslant 1/N \right\} = E
...
\end{df}
\begin{df}
 Пусть $ X $ --- множество. Набор подмножеств $ \mathcal{A} \in 2^X $ --- \textit{алгебра} множеств, если
 \begin{enumerate}
  \item $ \varnothing \in \mathcal{A} $
  \item $ A_1, A_2 \in \mathcal{A} \;\Longrightarrow\; A_1 \cap A_2 \in \mathcal{A} $
...
\begin{exmpl}\
 \begin{itemize}
  ...
  \item $ X = \R^2 $, $ \mathcal{A} = \left\{ E \subset X \mid E \text{ --- ограничено или } E^c \text { --- ограничено } \right\}  $. Тогда $ \mathcal{A} $ --- алгебра:
   ...
   \begin{align*}
    \mathcal{A} \not\ni \R^2 \setminus \left\{ (0, x) \mid x \geqslant 0 \right\}  = \bigcap_{k=1}^\infty A_k, \quad A_k \in \mathcal{A}
   .\end{align*} Нужно взять
   \begin{align*}
    A_k = \R^2 \setminus \left\{ (0, x) \mid 0 \leqslant x \leqslant k \right\} 
   .\end{align*}
  \item Если $ \mathcal{A} $ --- алгебра, то для любых $ A_1, \ldots, A_N \in \mathcal{A} $ верно $ \bigcup_1^N A_k \in \mathcal{A} $, так как
   \begin{align*}
