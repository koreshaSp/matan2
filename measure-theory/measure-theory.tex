...
\title{Матан СП 3 семестр. \\ Теория меры. \\ Конспект лекций.}
...
\begin{document}
\maketitle
Конспект лекций по математическому анализу в третьем семестре (второй курс, осень) СПбГУ МКН <<Современное программирование>> (набор 2021 года).
