...
\end{figure}
 ...
 \begin{align*}
	 \varointctrclockwise\limits_{\partial\Pi_n} f\,dz  = o(\max\limits_{z \in \Pi_n}\left| z-z_0 \right| \diam \Pi_n) = o(\left( \diam \Pi_n \right)^{2}).
...
\begin{figure}[ht]
    \centering
	\incfig[0.4]{theorem_cauchy_gurs_morer_1_to_3}
    \caption{Расположение объектов в ипликации $1, 2 \implies 3$. }
