...
\varlimsup_{n \to \infty} \int\limits_E f_n\, d\mu \geqslant \varlimsup_{n \to \infty} \sum_{k=1}^{N} \Theta c_k \mu(A_k \cap E_n)
...
\int\limits_E f \, d\mu \geqslant \varlimsup_{n \to \infty} \int\limits_E f_n \, d\mu \geqslant \varliminf_{n \to \infty} \int\limits_E f_n \, d\mu \geqslant \int\limits_E f \, d\mu
.\end{align*} Значит, \begin{align*}
\int\limits_E f \, d\mu = \lim_{n \to \infty} \int\limits_E f_n \, d\mu
.\end{align*} 
\end{proof}
\begin{crly}
